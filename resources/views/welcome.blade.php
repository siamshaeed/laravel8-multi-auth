    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <button class="text-white-700">Laravel Default Auth :</button>
                    <a href="{{ route('login') }}" class="text-sm text-white-700 btn btn-success">Login</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 text-sm text-white-700 btn btn-warning">Register</a>
                    @endif
            @endif
        </div>
        @endif
